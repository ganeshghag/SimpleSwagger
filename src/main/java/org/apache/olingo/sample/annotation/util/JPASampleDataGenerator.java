...
import com.ghag.rnd.swagger.simple.Task;
...
public class JPASampleDataGenerator {
  ...
  public void generateSampleData(String serviceUrl) {
    ...
    Task task1 = new Task();
    task1.setDescription("gandesc"+id);
    task1.setIsDone("true");
    task1.setId(id.intValue());
    //task1.setTargetDate(new Date());  //2018-06-17 00:00:00 in the MYSQL DB
    
    String task1str = gson.toJson(task1, type);
    createEntity(serviceUrl + "/Tasks",task1str,usedFormat);
